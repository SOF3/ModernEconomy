 ...
 * Created from account.mysql.sql, currency.mysql.sql, lock.mysql.sql, operation.mysql.sql, version.mysql.sql
 */
...
final class Queries{
	 ...
	 */
	public const CORE_VERSION_START_UPDATE = "core.version.start-update";
